...
void UART2_RX_Interrupt() __attribute__ ((weak, alias("Default_Handler")));
...
void Interrupt_Service_TPM1() __attribute__ ((weak, alias("Default_Handler")));
...
void (* const InterruptVector[])() __attribute__ ((section(".vectortable"))) = {
    ...
    UART2_RX_Interrupt, /* UART2 Status and Error interrupt */
    ADC0_IRQHandler, /* ADC0 interrupt */
    CMP0_IRQHandler, /* CMP0 interrupt */
    TPM0_IRQHandler, /* TPM0 */
    Interrupt_Service_TPM1, /* TPM1 */
